# src/methods/broadcasting_method.py
"""
broadcasting_method.py: A module that implements the broadcasting method for processing 2D arrays.
...
Example usage:
    ...
    from src.methods import broadcasting_method

    start_array = ...  # Your 2D input array
    end_array = ...    # Your 3D output array

    # Process the input array using the broadcasting method
    processed_array = broadcasting_method.process(start_array, end_array)

    # Benchmark the performance of the broadcasting method (timeit)
...
def process(start_array: ndarray, end_array: ndarray) -> ndarray:
    ...
    required.
    """
    multiplied_array = start_array * 255
    end_array[:, :, 0] = multiplied_array
    return end_array
